...
for zdt in zdts:
    for version in versions:
        ...
        for i in range(len(solvers)):
            filename = os.path.join(dirname, "num_fronts_snapshots/zdt" + zdt + "_" + solvers[i] + "_" + version + ".txt")
        ...
        filename = os.path.join(dirname, "num_fronts_snapshots/zdt" + zdt + "_" + version + ".png")
